...
const result = ["The Peninsula", "TST Clock Tower", "Shui Yuet Kung\nShan Tung Street", "St. Andrew Church", "1881 Heritage", "Red Brick House"]
...
let myChart = new Chart(wheel, {
    ...
    type: "pie",
    data: {
        labels: ["The Peninsula", "TST Clock Tower", "Shui Yuet Kung\nShan Tung Street", "St. Andrew Church", "1881 Heritage", "Red Brick House"],
        datasets: [
            {
